...
|---|---|
| Full Python suite | 1344 passed in the integrated local run |
...
| Differential mutation | FAIL: latest full CI run (35239651553, 4705c58) killed 14,927 of 15,584, with 657 survivors and no timeouts. The first run is in evidence/mutation.json |
