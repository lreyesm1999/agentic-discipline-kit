...
|---|---|
| Full Python suite | 1305 passed in the integrated local run |
...
| Differential mutation | FAIL: latest full CI run (35146094806, f11b4a7) killed 14,812 of 15,476, with 657 survivors and 7 timeouts. The first run is in evidence/mutation.json |
