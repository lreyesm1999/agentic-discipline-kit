...
|---|---|
| Full Python suite | 1339 passed in the integrated local run |
...
| Differential mutation | FAIL: latest full CI run (35178049230, db362f0) killed 14,926 of 15,625, with 692 survivors and 7 timeouts. The first run is in evidence/mutation.json |
