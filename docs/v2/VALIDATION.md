...
|---|---|
| Full Python suite | 1383 passed in the integrated local run |
...
| Differential mutation | FAIL: latest full CI run (35317358078, 7884b3e, the code merged as c97abac) killed 14,935 of 15,584, with 649 survivors and no timeouts; the gate proves 101 of them equivalent, leaving 548 unresolved. The first run is in evidence/mutation.json |
